...
export class CompanyService {
  ...
  getFreeAppointmentsForCompany(companyId: number, date : any): Observable<any>{
    return this.http.get<any>(`http://localhost:8080/api/appointments/getFreeAppointments/${companyId}/${date}`);
  }
